...
class CommoditiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commodity" do
    assert_difference('Commodity.count') do
      post commodities_url, params: { commodity: { code: @commodity.code, local_name: @commodity.local_name, name: @commodity.name, tag: @commodity.tag } }
    end
  ...
  test "should update commodity" do
    patch commodity_url(@commodity), params: { commodity: { code: @commodity.code, local_name: @commodity.local_name, name: @commodity.name, tag: @commodity.tag } }
