...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post containers_url, params: { container: { code: @container.code, quantity: @container.quantity, task_id: @container.task_id } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { code: @container.code, quantity: @container.quantity, task_id: @container.task_id } }
