...
class AssigneesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignee" do
    assert_difference('Assignee.count') do
      post assignees_url, params: { assignee: { assignement_id: @assignee.assignement_id, role_id: @assignee.role_id, team_id: @assignee.team_id } }
    end
  ...
  test "should update assignee" do
    patch assignee_url(@assignee), params: { assignee: { assignement_id: @assignee.assignement_id, role_id: @assignee.role_id, team_id: @assignee.team_id } }
