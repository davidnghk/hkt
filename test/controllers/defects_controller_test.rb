...
class DefectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create defect" do
    assert_difference('Defect.count') do
      post defects_url, params: { defect: { assignment_id: @defect.assignment_id, issue_id: @defect.issue_id, rating: @defect.rating, remarks: @defect.remarks } }
    end
  ...
  test "should update defect" do
    patch defect_url(@defect), params: { defect: { assignment_id: @defect.assignment_id, issue_id: @defect.issue_id, rating: @defect.rating, remarks: @defect.remarks } }
