...
class LaboratoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post laboratories_url, params: { laboratory: { code: @laboratory.code, local_name: @laboratory.local_name, name: @laboratory.name } }
    end
  ...
  test "should update laboratory" do
    patch laboratory_url(@laboratory), params: { laboratory: { code: @laboratory.code, local_name: @laboratory.local_name, name: @laboratory.name } }
