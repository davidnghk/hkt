...
class TeamAssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_assignment" do
    assert_difference('TeamAssignment.count') do
      post team_assignments_url, params: { team_assignment: { assignment_id: @team_assignment.assignment_id, role_id: @team_assignment.role_id, team_id: @team_assignment.team_id } }
    end
  ...
  test "should update team_assignment" do
    patch team_assignment_url(@team_assignment), params: { team_assignment: { assignment_id: @team_assignment.assignment_id, role_id: @team_assignment.role_id, team_id: @team_assignment.team_id } }
