...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post folders_url, params: { folder: { active: @folder.active, code: @folder.code, foldable_id: @folder.foldable_id, foldable_type: @folder.foldable_type, name: @folder.name } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { active: @folder.active, code: @folder.code, foldable_id: @folder.foldable_id, foldable_type: @folder.foldable_type, name: @folder.name } }
